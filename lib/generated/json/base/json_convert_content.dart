...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<MovieSearch>[] is M) {
      return data.map<MovieSearch>((Map<String, dynamic> e) =>
          MovieSearch.fromJson(e)).toList() as M;
    }
    if (<Movie>[] is M) {
      return data.map<Movie>((Map<String, dynamic> e) =>
          Movie.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (MovieSearch).toString(): MovieSearch.fromJson,
